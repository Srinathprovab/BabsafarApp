    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cellType = data?.cellType {
            ...
            case .VoucherHotelDetailsTVCell:
                let cell: VoucherHotelDetailsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
            ...
            case .TotalPremiumPayableTVCell:
                let cell:  TotalPremiumPayableTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .InsurenceFlightDetailsTVCell:
                let cell: InsurenceFlightDetailsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .ExploreTVCell:
                let cell: ExploreTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .QuickBookingResultTVCell:
                let cell: QuickBookingResultTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .SelectedServicesTVCell:
                let cell: SelectedServicesTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .FasttrackSearchTVCell:
                let cell: FasttrackSearchTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .ExploreResultTVCell:
                let cell: ExploreResultTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .ExploreSummeryTVCell:
                let cell: ExploreSummeryTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
            ...
            case .ExploreLeadPassengerTVCell:
                let cell: ExploreLeadPassengerTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .InsurenceResultTVCell:
                let cell: InsurenceResultTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
                
                
            case .FromLeadPassengerTVCell:
                let cell: FromLeadPassengerTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
