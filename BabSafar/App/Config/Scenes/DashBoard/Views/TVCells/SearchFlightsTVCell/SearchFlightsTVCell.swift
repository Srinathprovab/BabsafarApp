...
class SearchFlightsTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setupLabels(lbl: fromCitylbl, text: "dubai (DXB)", textcolor: .AppLabelColor, font: .LatoSemibold(size: 18))
        setupLabels(lbl: tolbl, text: "To", textcolor: .AppLabelColor, font: .LatoLight(size: 14))
        setupLabels(lbl: toCitylbl, text: "Kuwait (KWI)", textcolor: .AppLabelColor, font: .LatoSemibold(size: 18))
        ...
        setupLabels(lbl: returnDatelbl, text: "+ Add Return Date", textcolor: .AppLabelColor, font: .LatoSemibold(size: 18))
