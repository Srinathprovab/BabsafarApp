...
struct MBModel : Codable {
    ...
    let session_expiry_details : MBSession_expiry_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        session_expiry_details = try values.decodeIfPresent(MBSession_expiry_details.self, forKey: .session_expiry_details)
